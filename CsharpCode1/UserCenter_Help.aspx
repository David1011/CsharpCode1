<%@ page language="C#" autoeventwireup="true" inherits="UserCenter_Help, House_FreeV2_deploy" enableEventValidation="false" %>
...
<body>
    ...
    <div>
      ...
      <div class="currnav">
            ...
            <a href="UserCenter_Help.aspx">帮助中心</a>
        </div>
        ...
        <tr>
            ...
            <tr>
                <td class="item">
                    ...
                    <br />
                    <span class=blue>（注：个人可以免费发布　<b><%=Common.GetPersonInfoCount() %></b> 条信息（出租，出售），中介用户不受限制）</span>  
           ...
           <tr>
            ...
            <tr>
                <td class="mii" valign="top"  id="金牌">
                   <span id="four"><img src="images/helpico.gif" align="absmiddle" />&nbsp;<b>成为金牌会员有什么好处？  </b></span><br />
                </td>
            </tr>
            <tr>
                <td class="item">
                    ...
                    <b>· 什么是金牌会员？</b><br />
                    只要您注册成为本站会员，并购买本站的积分，您就会自动成为金牌会员！本站的金牌会员采用积分制度．
                    <br />
                    <b>· 金牌会员较普通会员有什么优势？</b><br />
            ...
            <tr>
                <td class="item">
                    <div class="lineheight2" style="text-align:left;">
                        ...
                        <br />
                        <span class=blue>注：一个积分 = <b><%=Common.GetScoreOfOneYuan() %></b> 元</span>
            ...
            <tr>
                <td class="mii" valign="top" id="getscore">
                   <span id="Span1"><img src="images/helpico.gif" align="absmiddle" />&nbsp;<b>如何赚取积分？</b></span><br />
                </td>
            </tr>
            <tr>
                <td class="item">
                    <div class="lineheight2" style="text-align:left;">
                        本站对会员采用积分制度进行管理。　您可以通过以下渠道来获取积分：<br />
                        1．通过论坛发表贴子。发表一个贴子（不包括回复）可以得到&nbsp;<font color=red><b><%=GetScoreOfOnePost()%></b></font>&nbsp;个积分。同时，如果您发表的贴子不合格（包括无实质内容贴子，违法贴子，在论坛里发布房源信息的贴子）被管理员删除，将被扣除&nbsp;<font color=red><b><%=GetScoreOfOnePost()%></b></font>&nbsp;个积分<br />
                        2．通过充值来直接获取积分。<a href="users_order.aspx"><font color=blue><u>点击此处立刻充值</u></font></a><br />
                    </div>
                 </td>
            </tr>
        </table><br />
