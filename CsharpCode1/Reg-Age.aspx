<%@ page language="C#" autoeventwireup="true" inherits="Reg_Age, House_FreeV2_deploy" enableEventValidation="false" %>
...
<head runat="server">
        <title>注册经纪人，<%=Common.GetCityName() %>房产中介频道,<%=Common.GetCityName() %>房产网,<%=Common.GetCityName() %>房产网</title>
            ...
            <table cellpadding="0" border="0" cellspacing="5" width="800" align="center">
             ...
             <tr>
                <td style="font-size:15px;font-weight:bold;border-bottom:4px solid #adc869;padding-bottom:8px;" align="left">
                    <img src="images/images_07.jpg" align="absmiddle" />&nbsp;经纪人快速注册 ( <font color=red>*</font> 为必填项)</td>
             </tr>
            <tr>
                <td class=rightitem valign="top">
                   <table width=100% style="border:1px solid #ccc;background:#f3f3f3;padding-top:8px;">
                       ...
                       <tr>
                           <td bgcolor="#ffffff" class="alignright" nowrap="nowrap" style="width: 96px">
                               <span style="color: #ff0000">*</span> 所属公司：</td>
                           <td align="left" bgcolor="#ffffff" class="classic">
                               &nbsp;<asp:TextBox ID="tbcompany" runat="server" CssClass="btninput" Width="145px"></asp:TextBox>
                               输入公司名称，例：中原地产、满堂红地产</td>
                       </tr>
                       <tr>
                           <td bgcolor="#ffffff" class="alignright" nowrap="nowrap" style="width: 96px">
                               <span style="color: #ff0000">*</span> 公司地址：</td>
                           <td align="left" bgcolor="#ffffff" class="classic">
                               &nbsp;<asp:TextBox ID="tbaddress" runat="server" CssClass="btninput" Width="145px"></asp:TextBox>
                               建议输入完整地址以便客户寻找</td>
                       </tr>
                       <tr>
                           <td bgcolor="#ffffff" class="alignright" nowrap="nowrap" style="width: 96px">
                               <span style="color: #ff0000">*</span> 负责区域：</td>
                           <td align="left" bgcolor="#ffffff" class="classic">
                    ...
                    <table width=100% style="border:1px solid #ccc;background:#f3f3f3;">
                        ...
                        <tr>
                            ...
                            <td align="left" bgcolor="#ffffff" class="classic">
                                ...
                                &nbsp;建议上传，有利于增加客 户对您的信任感。可以是个人形象或公司门店形象，必须是真实的。</td>
                        </tr>
