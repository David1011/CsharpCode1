<%@ page language="C#" autoeventwireup="true" inherits="Users_ScoreERROR, House_FreeV2_deploy" enableEventValidation="false" %>
    ...
    <table cellpadding="0" cellspacing="10" border="0" width="980">
        <tr>
           ...
           <div class=border>
               ...
               <div class="msgtip">
                <br />
                    很抱歉，无法发布信息．您可发布的信息数量已满！ 详细信息如下<br />
                    <div class=black style="width:520px;text-align:left;">
                        <b>个人用户可发布： <font color=red><b><%=Common.GetPersonInfoCount() %></b></font> 条出租信息，
                         <font color=red><b><%=Common.GetPersonInfoCount() %></b></font> 条出售信息
                        您可以进行以下操作:</b>
                        <br />
                        1．删除原有信息 (无需积分)
                        <br />
                        2．刷新原有信息 (需要 <font color=red><b><%=Common.GetRefleshScore() %></b></font> 个积分)
                        <br />
                        3．设置为火急房源 (需要 <font color=red><b><%=Common.GetRecomScore() %></b></font> 个积分)
                        <br />
                        4．置顶原有信息 (需要 <font color=red><b><%=Common.GetTopScore() %></b></font> 个积分)
