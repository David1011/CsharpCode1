<%@ page language="C#" autoeventwireup="true" inherits="AddQiuZu_Anon, House_FreeV2_deploy" enableEventValidation="false" %>
...
<body>
    ...
    <div>
      ...
      <div class="currnav">
            ...
            您的位置：
            <a href='<%=FormatUrl.HomeUrl() %>'>网站首页</a>&nbsp;>&nbsp;&nbsp;发布求租信息
        </div>
                   ...
                   <table width=100% style="border:1px solid #ccc;background:#f3f3f3;">
                        ...
                        <tr>
                           ...
                           <td bgcolor="#ffffff"  align="left" style="height: 43px">
                               ...
                               <span style="color: #808080">&nbsp;最多50个汉字，例：求租海珠区两房1800以内<br />
                       ...
                       <tr>
                           ...
                           <td align="left" bgcolor="#ffffff" valign="top">
                               ...
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="FreeTextBox1"
