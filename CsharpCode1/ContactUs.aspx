<%@ page language="C#" autoeventwireup="true" inherits="ContactUs, House_FreeV2_deploy" enableEventValidation="false" %>
            ...
            <tr>
                <td width="150" style="border-right:1px dotted #ccc;" valign="top">
                 ...
                 <td width="615" valign="top">
                    <div class="companyhead">·联系我们</div>
                    <div class="companyitem"><%=contactus %></div>
                </td>
            </tr>
        </TABLE>
