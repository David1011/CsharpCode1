<%@ page language="C#" autoeventwireup="true" inherits="AddSell, House_FreeV2_deploy" validaterequest="false" enableEventValidation="false" %>
...
<head runat="server">
         <title>发布二手房出售信息,我的管理中心,<%=Common.GetSiteName() %></title>
    ...
    <table cellpadding="0" cellspacing="10" border="0" width="980">
        <tr>
            ...
            <td  valign="top">
                <div class="border">
                    <div class="titlehead" >
                        <div class="floatleft">发布出售信息</div>
                        <div class="floatright"><a href="UserCenter_Help.aspx#two" target="_blank">如何发布信息更有效果？</a></div>
                    </div>
                    <div>
                   ...
                   <table width=100% style="border:1px solid #ccc;background:#f3f3f3;">
                        ...
                        <tr>
                           ...
                           <td bgcolor="#ffffff"  align="left">
                               &nbsp;<asp:TextBox ID="tbtitle" runat="server" Width="410px"></asp:TextBox>&nbsp;<a href="UserCenter_Help.aspx#five" target="_blank"><u>如何填写标题更吸引人？</u></a>
                       ...
                       <tr>
                        ...
                        <tr>
                           <td bgcolor="#f6f6f6" class="alignright" nowrap="nowrap" >
                                <font color="red"><b>*</b></font>&nbsp;房屋售价：</td>
