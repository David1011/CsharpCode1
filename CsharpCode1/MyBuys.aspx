<%@ page language="C#" autoeventwireup="true" inherits="MyBuys, House_FreeV2_deploy" enableEventValidation="false" %>
...
<body>
    ...
    <div>
     ...
     <div class="currnav">
            ...
            <a href='<%=FormatUrl.MyAgentCenterBuy() %>'>管理求购信息</a>
        </div>
            ...
            <tr>
               ...
               <asp:DataGrid  HeaderStyle-Wrap="false"  id="dgUsers" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="20" DataKeyField="QGID" HeaderStyle-CssClass="columnHeadCSS" ItemStyle-CssClass="columnItemCSS" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" CellPadding="4" OnDeleteCommand="dgUsers_DeleteCommand" BorderColor="#DEDFDE" OnItemCreated="dgUsers_ItemCreated" BackColor="White" BorderStyle="None" BorderWidth="1px" ForeColor="Black">
				...
				<Columns>
                    ...
                    <asp:TemplateColumn>
                        <ItemTemplate>
                            <a  href='<%#FormatUrl.AddBuyUrl()+"?ID="+Eval("QGID") %>'>修改</a>
                        </ItemTemplate>
					...
					<asp:TemplateColumn HeaderText="标题">
						...
						<ItemTemplate>
							<asp:HyperLink id=HyperLink1 runat="server" Text='<%#Common.myStringWidthoutDot(Eval("Title").ToString(),15) %>' Target="_blank" NavigateUrl='<%#FormatUrl.BuyHouseContentUrl(Eval("QGID").ToString()) %>'>
							</asp:HyperLink>
						</ItemTemplate>
					</asp:TemplateColumn>
