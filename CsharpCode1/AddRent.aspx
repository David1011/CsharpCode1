<%@ page language="C#" autoeventwireup="true" inherits="AddRent, House_FreeV2_deploy" validaterequest="false" enableEventValidation="false" %>
...
<head runat="server">
     <title>发布出租信息,我的管理中心,惠州房产网</title>
            ...
            <td  valign="top">
                <div class="border">
                    <div class="titlehead" >
                        ...
                        <div class="floatleft"><%=TEMPTITLE %>出租信息</div>
