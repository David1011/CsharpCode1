<%@ page language="C#" autoeventwireup="true" inherits="MyWT, House_FreeV2_deploy" enableEventValidation="false" %>
    ...
    <table cellpadding="0" cellspacing="10" border="0" width="980">
        <tr>
            ...
            <td valign="top">
                <div class="border">
                    <div class="titlehead">
                        <div class="floatleft">我收到的委托信息</div>
                        <div class="normalright">查看一条用户委托需扣除个 <b><%=Common.GetRecomAgentScore() %></b> 积分,已读的不扣分&nbsp;&nbsp;&nbsp;</div>
                    </div>
                                                            <div>
            ...
            <tr>
                ...
                <asp:DataGrid id="dgUsers" runat="server" Width="98%" CellPadding="4" AutoGenerateColumns="False"
								PageSize="20" DataKeyField="WTID" OnDeleteCommand="dgUsers_DeleteCommand" OnItemCreated="dgUsers_ItemCreated" ForeColor="#333333">
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="委托摘要" HeaderStyle-Wrap="false">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink22" Target="_blank"  NavigateUrl='<%#"showshopwt.aspx?WTID="+Eval("WTID").ToString() %>' runat="server"><%#Common.myStringWidthDot(Eval("Content").ToString(),15) %></asp:HyperLink>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateColumn>

                                    
									<asp:BoundColumn DataField="AddDate" DataFormatString="{0:d}" HeaderText="收到日期" HeaderStyle-Wrap="false">
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:TemplateColumn HeaderText="状态" HeaderStyle-Wrap="false">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink2" Target="_blank" NavigateUrl='<%#"showshopwt.aspx?WTID="+Eval("WTID").ToString() %>' runat="server">详细</asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
								</Columns>
