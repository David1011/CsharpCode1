<%@ page language="C#" autoeventwireup="true" inherits="MyRentComments, House_FreeV2_deploy" enableEventValidation="false" %>
        ...
        <tr>
            ...
            <tr>
                <td class=rightitem valign="top">
                    <asp:DataGrid ID="dlsellcom" runat="server"  AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="98%">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="对应房源">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" Target=_blank runat="server" NavigateUrl='<%#FormatUrl.RentContentUrl(Convert.ToString(Eval("RentID"))) %>' Text='<%#Common.myStringWidthoutDot(Eval("Title").ToString(),15) %>'>
                            ...
                            <asp:TemplateColumn>
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink2" runat="server" Target=_blank><a href='<%#FormatUrl.RentContentUrl(Convert.ToString(Eval("RentID"))) %>'>查看>></a></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
